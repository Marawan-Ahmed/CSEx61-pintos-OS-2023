...
{
    load_avg.value = multiply_fp(divide_fp(convert_to_fp(59),convert_to_fp(60)),load_avg.value) + divide_fp(convert_to_fp(1),convert_to_fp(60))*(thread_current() == idle_thread ? list_size(&ready_list) : list_size(&ready_list)+1);
}
